            ...
            <div class="col-12">
                ...
                <div class="card-box">
                    ...
                    <table id="basic-datatable"
                        class="table table-hover m-0 table-centered dt-responsive nowrap w-100 table-bordered">
                        <thead>
                            <tr>
                                <th>Sr No</th>
                                <th>Invoice No</th>
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{ route('print-gst-bill', $bill->id) }}"><i
                                                        class="mdi mdi-printer mr-2 text-muted font-18 vertical-middle"></i>Print</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('print-gst-bill', [$bill->id, 'usd']) }}"><i
                                                        class="mdi mdi-printer mr-2 text-muted font-18 vertical-middle"></i>Print
                                                    USD Bill</a>
                                            </div>
                                        </div>
                                    </td>
